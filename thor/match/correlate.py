...
def get_ambient_flow(input_record, object_tracks, object_options):
    ...
    flow_region1 = np.copy(raw1[row_lb : row_ub + 1, col_lb : col_ub + 1])
    flow_region2 = np.copy(raw2[row_lb : row_ub + 1, col_lb : col_ub + 1])

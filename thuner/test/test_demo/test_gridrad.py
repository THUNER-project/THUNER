...
def test_gridrad():
    ...
    records = attribute.utils.read_attribute(output_parent, "records", "filepaths", "gridrad")
    ...
    classifications = attribute.utils.read_attribute(output_parent, "analysis", "classification")

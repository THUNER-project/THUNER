...
def test_gridrad():
    ...
    #
    # ![Animation depicting tracked MCSs.](https://raw.githubusercontent.com/THUNER-project/THUNER/refs/heads/main/gallery/gridrad_mcs_20100120.gif)
    # ## Setup
    ...
    # [Short et al. (2023)](https://doi.org/10.1175/MWR-D-22-0146.1). By default, figures and animations are saved in the `output_parent` directory in the `visualize` folder. The code below should generate an animation `gridrad_mcs_20100120.gif`, matching the
    ...
    # notebook can embed a stable, online-hosted copy (the figure at the top).
    gif_filepath = output_parent / f"visualize/{name}.gif"
    utils.copy_to_gallery(gif_filepath)
